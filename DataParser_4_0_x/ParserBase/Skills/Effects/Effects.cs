namespace Jamie.Skills {
	...
	public partial class Effects {
		...
		[XmlElement("healinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(HealInstantEffect))]
		[XmlElement("mpheal", Form = XmlSchemaForm.Unqualified, Type = typeof(MpHealEffect))]
		[XmlElement("mphealinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(MpHealInstantEffect))]
		...
		[XmlElement("dphealinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(DpHealInstantEffect))]
		[XmlElement("fpheal", Form = XmlSchemaForm.Unqualified, Type = typeof(FpHealEffect))]
		[XmlElement("fphealinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(FpHealInstantEffect))]
		[XmlElement("skillatk", Form = XmlSchemaForm.Unqualified, Type = typeof(SkillAttackInstantEffect))]
		[XmlElement("spellatkinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(SpellAttackInstantEffect))]
		...
		[XmlElement("prochealinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(ItemHealEffect))]
		[XmlElement("procmphealinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(ItemHealMpEffect))]
		[XmlElement("procdphealinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(ItemHealDpEffect))]
		[XmlElement("procfphealinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(ItemHealFpEffect))]
		...
		[XmlElement("boostskillcost", Form = XmlSchemaForm.Unqualified, Type = typeof(ChangeMpConsumptionEffect))]
		...
		[XmlElement("mpattack", Form = XmlSchemaForm.Unqualified, Type = typeof(MpAttackEffect))]
		[XmlElement("mpattackinstant", Form = XmlSchemaForm.Unqualified, Type = typeof(MpAttackInstantEffect))]
        ...
        [XmlElement("extendedaurarange", Form = XmlSchemaForm.Unqualified, Type = typeof(ExtendAuraRangeEffect))]
		...
		[XmlElement("resurrectpos", Form = XmlSchemaForm.Unqualified, Type = typeof(ResurrectPositionalEffect))]
        ...
        [XmlElement("wpndual", Form = XmlSchemaForm.Unqualified, Type = typeof(WeaponDualEffect))]
		...
		[XmlElement("condskilllauncher", Form = XmlSchemaForm.Unqualified, Type = typeof(CondSkillLauncherEffect))]
