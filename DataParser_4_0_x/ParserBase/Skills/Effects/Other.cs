namespace Jamie.Skills
{
	...
	public class AbstractTransformEffect : Effect
	{
		...
		public override void Import(ClientEffect importObject, IEnumerable<FieldInfo> getters) {
			...
			if (importObject.reserved[7] != null)
				this.type = (TransformType)Enum.Parse(typeof(TransformType), importObject.reserved[7].Trim().ToUpper(), true);
    ...
    public sealed class XPBoostEffect : Effect
    {
	   ...
	   */
        public override void Import(ClientEffect importObject, IEnumerable<FieldInfo> getters) {
		   ...
		   // Need to fix, should have enumerated change attributes like statboost
    ...
    public sealed class CondSkillLauncherEffect : Effect {
	    ...
	    public override void Import(ClientEffect importObject, IEnumerable<FieldInfo> getters) {
		    ...
		    this.e = importObject.e;
		    this.effectid = importObject.effectid;
		    this.noresist = importObject.noresist;
		    
		    // zer0patches need to get skillid for effect id?
		    this.skill_id = Utility.SkillIndex[importObject.reserved[2].Trim()].id;

		    this.type = importObject.reserved[12].Trim();
