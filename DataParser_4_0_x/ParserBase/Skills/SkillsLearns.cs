namespace Jamie.Skills
{
    ...
    public partial class LearnSkill
    {
	   ...
	   [XmlIgnore]
	   [DefaultValue(skillRace.PC_ALL)]
	   public skillRace skillRace {
		   get {
			   if (String.IsNullOrEmpty(race) || race.ToUpper() == "ALL")
				   return skillRace.PC_ALL;
			   string[] races = race.Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
			   if (races.Length > 1)
				   return skillRace.PC_ALL;
			   else if (races[0].ToUpper() == "PC_LIGHT")
				   return skillRace.ELYOS;
			   else
				   return skillRace.ASMODIANS;
		   }
	   }
	   ...
	   public string classId {
		   get {
			   switch (@class) {
				   case "FIGHTER": return "GLADIATOR";
				   case "KNIGHT": return "TEMPLAR";
				   case "WIZARD": return "SORCERER";
				   case "ELEMENTALLIST": return "SPIRIT_MASTER";
				   case "PRIEST": return (pc_level < 10 ? "PRIEST" : "CLERIC");
