namespace Jamie.ParserBase {
	...
	public partial class ClientNpcsFile {
		...
		Dictionary<string, Npc> teleportNametoNpcId = null;
		...
		internal void CreateIndex() {
			...
			teleportNametoNpcId = new Dictionary<string, Npc>(StringComparer.InvariantCultureIgnoreCase);
			...
			foreach (Npc npc in this.NpcList) {
				...
				if (npc.airlines_name != null) {
					if (teleportNametoNpcId.ContainsKey(npc.airlines_name)) {
						if (npc.ment != null) {
							teleportNametoNpcId.Remove(npc.airlines_name);
							teleportNametoNpcId.Add(npc.airlines_name, npc);
						}
					}
					else {
						teleportNametoNpcId.Add(npc.airlines_name, npc);
		...
		public Npc getTeleportNpcFromString(string airlines_name) {
				if (teleportNametoNpcId == null || !teleportNametoNpcId.ContainsKey(airlines_name))
					return null;
				return teleportNametoNpcId[airlines_name];
		}
	...
	public partial class Npc {
		...
		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool exclusion_list;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public int hide_path;
        ...
        public int town_residence;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]//4.0
        public int omit_system_msg;
		...
		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_personal_auction;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_housing_pay_rent;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_housing_kick;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_housing_change_building;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_housing_config;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_housing_script;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_recreate_personal_ins;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public int func_itemcharge2;
		...
		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_giveup_craftskill;
		...
		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool func_enterhouse_to_instant;
		...
		#region Added in 1.9 - 2.0 - 3.0

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public int instance_entry;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public string ins_creation_id_1;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public string ins_creation_id_2;
		...
		[XmlElement("trade_in_trade_info", Form = XmlSchemaForm.Unqualified)]
		public TradeInfo TradeInTradeInfo;
	}
	...
	public enum NpcFunction {
		...
		housing_servant,
		housing_teleportobj,
		housing_signpost_nosale,
		housing_signpost_sale,
		housing_signpost_waiting,
		housing_signpost_home,
		housing_personal_auction,

        //3.5
        town_challenge_task,
        BindingStone = Bindstone
	...
	public partial class VisibleEquipment {
		...
		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public string wing_mesh;

		[XmlElement(Form = XmlSchemaForm.Unqualified)]
		public bool wing_always;
	}
