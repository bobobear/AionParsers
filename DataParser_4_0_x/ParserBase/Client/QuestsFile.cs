namespace Jamie.ParserBase
{
    ...
    public class QuestItems
    {
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string bard_selectable_item;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string gunner_selectable_item;
    }
    ...
    public partial class Quest : IAdvice
    {
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int reward_challenge_task1;
        // Permissions
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string areas;
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string finished_quest_cond6;
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string unfinished_quest_cond6;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string unfinished_quest_cond7;
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string noacquired_quest_cond6;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string noacquired_quest_cond7;
        ...
        public string reward_exp5;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]//4.0
        public string reward_exp6;
        ...
        [XmlArray(Form = XmlSchemaForm.Unqualified)]
        [XmlArrayItem(ElementName = "data")]
        public QuestItems[] bard_selectable_reward;//4.0

        [XmlArray(Form = XmlSchemaForm.Unqualified)]
        [XmlArrayItem(ElementName = "data")]
        public QuestItems[] gunner_selectable_reward;//4.0
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item1_9;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item1_10;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item1_11;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item1_12;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int reward_gold1;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int reward_score1;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int reward_score_ext;
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item5_1;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item5_2;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item5_3;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item5_4;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item5_5;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int reward_gold5;

        // Reward item 6 (4.0)

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item6_1;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int reward_gold6;
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string reward_item_ext_3;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string reward_item_ext_4;
        ...
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item_ext_9;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string selectable_reward_item_ext_10;
        ...
        // 2.1
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string quest_repeat_cycle;

        // 2.6
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int mentor_quest_type;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public string acquired_quest_cond2;

        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public int pcguild_level;
        ...
        public bool HasRandomRaward()
        {
            return reward_item1_1 != null && reward_item1_1.StartsWith("%Quest_") ||
                   ...
                   reward_item1_5 != null && reward_item1_5.StartsWith("%Quest_");
        }
