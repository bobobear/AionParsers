namespace Jamie.ParserBase
{
    ...
    {
        [XmlElement("flying_zone")]
	    public MissionCommonShapeListFlying_zonesFlying_zone_zone[] flying_zone;
    ...
    [Serializable]
    [XmlType(AnonymousType = true)]
    public partial class MissionCommonShapeListFlying_zonesFlying_zone_zone {
	    [XmlElement("points_info")]
	    public points_info points_info;
